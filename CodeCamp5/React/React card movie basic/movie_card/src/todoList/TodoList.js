    ...
    render() {
        return (
            <div style={{margin: "50px auto", display: "grid", gridTemplateColumns: "50% 50%", width: "600px", justifyContent: "center", gridColumnGap: "10px", height: "400px"}}>
                <div style={{display: "flex", justifyContent: "space-between", flexDirection: "column", backgroundColor: "whitesmoke", width: "100%"}}>
                    <div>
                        <h3 style={{width: "100%", background: "gray"}}>todoList</h3> 
                        <ul style={{width: "none"}} className="todolist">
                            {this.state.todo.map((ele, idx) => <li> <span onClick={ () => this.edit(idx)}{ele}></span><img src={next} className="next" style={{width: "20px", position: "relative", top: "5px"}} onClick={() => this.move(idx)}></img> </li>)}
                        </ul>
                    </div>
                    <div>
                ...
                <div style={{backgroundColor: "wheat", height: "100%", width: "100%"}}>
                    <div style={{width: "100%", backgroundColor: "gray"}}>complete</div>
